...
function NoteForBatchUpload({ visible, close }) {
  ...
  return (
    <div className="fixed inset-0  flex justify-center items-center">
      <div className="bg-black bg-opacity-5 backdrop-blur-[1px] h-[600px] w-[800px] flex justify-center items-center">
        <div className="bg-white h-[40%] w-[65%] shadow-lg shadow-black rounded-md flex flex-col place-content-center items-center">
